...
const DngDsdConfig: React.FC = () => (
  <div>
    ...
    <div className="url-list">
      {DNG_DSD_URLS.map((url, i) => (<div className="url-row" key={i}><input className="form-input" defaultValue={url} /><Button variant="ghost" size="sm"><span className="material-symbols-outlined" style={{fontSize: 16}}>close</span></Button></div>))}

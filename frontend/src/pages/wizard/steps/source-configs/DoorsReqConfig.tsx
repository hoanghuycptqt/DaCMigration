...
import { DOORS_REQ_MODULES } from '../../../../data/wizard';
import NotificationBanner from '../../../../components/feedback/NotificationBanner';
import Button from '../../../../components/ui/Button';
import '../steps.css';
const DoorsReqConfig: React.FC = () => (
  <div>
    <h2 className="step-title">DOORS Requirements Configuration</h2>
    ...
    <h3 className="section-label">DOORS Module Information</h3>
    <table className="data-table"><thead><tr><th>Module Name</th><th>DOORS Path</th><th>Baseline Version</th></tr></thead><tbody>
      {DOORS_REQ_MODULES.map((m, i) => (<tr key={i}><td>{m.moduleName}</td><td>{m.doorsPath}</td><td>{m.baselineVersion}</td></tr>))}
